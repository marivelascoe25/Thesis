...
In this subsection, stability tests were conducted on both undoped and doped p(g3T2-T) samples. These samples we doped with F$_{6}$TCNNQ, following same procedure described in subsection \ref{subsec:films}. The channel conductivity was measured at various stages of the photolithography process, while a fixed biased drain-source voltage was maintained, under N$_{2}$ and ambient conditions. %, upon spin-coating, patterning, i) upon dropcast of solid-state electrolyte precursor, and after exposure, ii) after photopatterned solid-state electrolyte, and finally
