...
\begin{figure}[ht]
	\centering
	\subfloat[]{{\includegraphics[width=5cm]{Images/OMIECetransport1.png} }}
	%\qquad
	\subfloat[]{{\includegraphics[width=5cm]{Images/OMIECetransport2.png} }}
	\caption{Schematic representation of electronic charge transport mechanisms: A) "Thermally activated hopping transport of a relatively localized electronic charge carrier" and B) "band-like transport of a relatively delocalized electronic charge carrier". Modified from reference \cite{paulsenOrganicMixedIonic2020}.}
	\label{fig:etrans}
\end{figure}
...
\begin{figure}[ht]
	\centering
	\subfloat[]{{\includegraphics[width=5cm]{Images/OMIECitransport1.png} }}
	%\qquad
	\subfloat[]{{\includegraphics[width=5cm]{Images/OMIECitransport2.png} }}
...
\begin{figure}[ht]
	\centering
	\subfloat[]{{\includegraphics[height=2cm]{Images/film_model.png} }}
	\subfloat[]{{\includegraphics[height=4cm]{Images/circuit_model.png} }}
