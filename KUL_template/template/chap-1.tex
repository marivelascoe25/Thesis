...
\begin{figure}[h]
	\centering
	\subfloat[Typical OECT structure]{{\includegraphics[width=3.5cm]{Images/pdf/structure.pdf} }}
	%\qquad
	...
	\hspace{2em}
	\subfloat[Electronic and ionic circuits]{{\includegraphics[width=8cm]{Images/pdf/circuits.pdf} }}
